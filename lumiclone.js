...
/* harmony export (immutable) */ __webpack_exports__["a"] = BlockStateEnum;
...
/* harmony export (immutable) */ __webpack_exports__["b"] = BlockTypeEnum;
...
/* harmony export (immutable) */ __webpack_exports__["d"] = Instructions;
...
/* harmony export (immutable) */ __webpack_exports__["c"] = GameState;
...
const flipMatrix = matrix => map(index => pluck(index, matrix), rangeFrom(matrix));

const rotateMatrix = compose(flipMatrix, reverse);
/* harmony export (immutable) */ __webpack_exports__["b"] = rotateMatrix;

const rotateMatrixCounterClockwise = compose(reverse, flipMatrix);
/* harmony export (immutable) */ __webpack_exports__["c"] = rotateMatrixCounterClockwise;
...
class CompositeBlock {
  constructor(length, height) {
    ...
    for (let i = 0; i < length; i += 1) {
      ...
      for (let j = 0; j < height; j += 1) {
        tempRow.push({
          type: __WEBPACK_IMPORTED_MODULE_0__utils_constants__["b" /* BlockTypeEnum */].NONE,
          state: __WEBPACK_IMPORTED_MODULE_0__utils_constants__["a" /* BlockStateEnum */].NORMAL,
          count: 0
        });
      }
  ...
  rotateRight() {
    this.grid = Object(__WEBPACK_IMPORTED_MODULE_1__utils_utils__["c" /* rotateMatrixCounterClockwise */])(this.grid);
  }

  rotateLeft() {
    this.grid = Object(__WEBPACK_IMPORTED_MODULE_1__utils_utils__["b" /* rotateMatrix */])(this.grid);
  }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = CompositeBlock;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_App__ = __webpack_require__(28);
const React = __webpack_require__(0);
const ReactDOM = __webpack_require__(19);


ReactDOM.render(React.createElement(__WEBPACK_IMPORTED_MODULE_0__components_App__["a" /* App */], null), document.getElementById('app'));
...
*/
var aa=__webpack_require__(5),ba=__webpack_require__(0),m=__webpack_require__(10),p=__webpack_require__(4),v=__webpack_require__(3),da=__webpack_require__(11),ea=__webpack_require__(12),fa=__webpack_require__(13),ha=__webpack_require__(6);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Game__ = __webpack_require__(29);
const React = __webpack_require__(0);
...
class App extends React.Component {
  render() {
    return React.createElement(
      ...
      React.createElement(__WEBPACK_IMPORTED_MODULE_0__Game__["a" /* Game */], { length: 16, height: 10, timeLimit: 60 })
    );
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__structs_CompositeBlock__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structs_Board__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__structs_Queue__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_constants__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Engine__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Screen__ = __webpack_require__(34);
const React = __webpack_require__(0);
...
class Game extends React.Component {
  ...
  getNewGameState() {
    let nextBlocks = new __WEBPACK_IMPORTED_MODULE_2__structs_Queue__["a" /* Queue */]();
    for (let i = 0; i < 3; i += 1) {
      nextBlocks.enqueue(this.generateNextBlock());
    }

    return {
      grid: new __WEBPACK_IMPORTED_MODULE_1__structs_Board__["a" /* Board */](this.props.length, this.props.height),
  ...
  startCountdownTimer() {
    this.startTimerID = setInterval(() => this.setState({ startCountdownTime: this.state.startCountdownTime - 1 }), 1000);
  }
  ...
  startGameTimer() {
    if (this.gameTimerID === null) {
      this.gameTimerID = setInterval(() => this.setState({ currTime: this.state.currTime - 1 }), 1000);
    }
  }
  ...
  generateNextBlock() {
    let block = new __WEBPACK_IMPORTED_MODULE_0__structs_CompositeBlock__["a" /* CompositeBlock */](2, 2);

    for (let i = 0; i < 2; i += 1) {
      for (let j = 0; j < 2; j += 1) {
        let type = __WEBPACK_IMPORTED_MODULE_3__utils_constants__["b" /* BlockTypeEnum */].NONE;
        if (Math.random() <= 0.5) {
          type = __WEBPACK_IMPORTED_MODULE_3__utils_constants__["b" /* BlockTypeEnum */].T1;
        } else {
          type = __WEBPACK_IMPORTED_MODULE_3__utils_constants__["b" /* BlockTypeEnum */].T2;
        }
        block.setBlockAt(i, j, { type: type, state: __WEBPACK_IMPORTED_MODULE_3__utils_constants__["a" /* BlockStateEnum */].NORMAL });
      }
    }
    return block;
  }
  ...
  render() {
    ...
    if (this.state.startCountdownTime >= 0) {
      game_state = __WEBPACK_IMPORTED_MODULE_3__utils_constants__["c" /* GameState */].STARTING;
    } else if (currentTime >= 0) {
      this.startGameTimer();
      game_state = __WEBPACK_IMPORTED_MODULE_3__utils_constants__["c" /* GameState */].IN_PROGRESS;
      engine = React.createElement(__WEBPACK_IMPORTED_MODULE_4__Engine__["a" /* Engine */], {
      ...
      game_state = __WEBPACK_IMPORTED_MODULE_3__utils_constants__["c" /* GameState */].ENDED;
      currentTime = 0;
      this.removeGameTimer();
    }
    ...
    return React.createElement(
      ...
      null,
      engine,
      React.createElement(__WEBPACK_IMPORTED_MODULE_5__Screen__["a" /* Screen */], {
        grid: this.state.grid,
        currBlock: this.state.currBlock,
        currBlockLocation: this.state.currBlockLocation,
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__CompositeBlock__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_constants__ = __webpack_require__(2);



class Board extends __WEBPACK_IMPORTED_MODULE_0__CompositeBlock__["a" /* CompositeBlock */] {
  constructor(length, height) {
    super(length, height);
  }
  ...
  isOverlap(x, y, block) {
    ...
    for (let i = 0; i < block.getLength(); i += 1) {
      for (let j = block.getHeight() - 1; j >= 0; j -= 1) {
        try {
          if (this.getValue(x + i, y + j).type !== __WEBPACK_IMPORTED_MODULE_1__utils_constants__["b" /* BlockTypeEnum */].NONE) {
            return true;
          }
        } catch (err) {
          return false;
  ...
  addBlock(x, block) {
    ...
    for (let i = 0; i < block.getLength(); i += 1) {
      for (let j = block.getHeight() - 1; j >= 0; j -= 1) {
        for (let k = this.getHeight() - 1; k >= 0; k -= 1) {
          if (this.getValue(x + i, k).type === __WEBPACK_IMPORTED_MODULE_1__utils_constants__["b" /* BlockTypeEnum */].NONE) {
            if (k < 0) {
              continue;
            }
    ...
    this.resetAllBlocks();
    this.resolveBlocks(this.getLength() - 2, this.getHeight() - 1, __WEBPACK_IMPORTED_MODULE_1__utils_constants__["b" /* BlockTypeEnum */].T1);
    this.resolveBlocks(this.getLength() - 2, this.getHeight() - 1, __WEBPACK_IMPORTED_MODULE_1__utils_constants__["b" /* BlockTypeEnum */].T2);
  }

  resetAllBlocks() {
    for (let y = 0; y < this.getHeight(); y += 1) {
      for (let x = 0; x < this.getLength(); x += 1) {
        if (this.getValue(x, y).state !== __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].INACTIVE) {
          this.setBlockAt(x, y, { state: __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].NORMAL, count: 0 });
        } else {
  ...
  resolveBlocks(start_x, start_y, t) {
    ...
    while (x >= 0) {
      // start next col
      if (this.getValue(x, y).type === __WEBPACK_IMPORTED_MODULE_1__utils_constants__["b" /* BlockTypeEnum */].NONE) {
        x -= 1;
        y = this.getHeight() - 1;
        continue;
      }
      ...
      if (this.has2x2BlockPattern(x, y, t)) {
        ...
        if (tr.count && !tl.count && !bl.count && !br.count) {
          let state = tr.state === __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].INACTIVE ? __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].INACTIVE : __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].ACTIVE;
          this.setBlockAt(x + 1, y, { state, count });
        }

        if (!tl.count) {
          let state = tl.state === __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].INACTIVE ? __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].INACTIVE : __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].ACTIVE;
        ...
        if (!bl.count) {
          let state = bl.state === __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].INACTIVE ? __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].INACTIVE : __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].ACTIVE;
          this.setBlockAt(x, y + 1, { state, count });
        }
        if (!br.count) {
          let state = br.state === __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].INACTIVE ? __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].INACTIVE : __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].ACTIVE;
  ...
  has2x2BlockPattern(x, y, t) {
    try {
      ...
      if (tl.state === __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].ACTIVE) {
        return tl.type === t && tl.state !== __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].INACTIVE && tr.type === t && tr.state !== __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].INACTIVE && bl.type === t && bl.state !== __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].INACTIVE && br.type === t && br.state !== __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].INACTIVE;
      }

      return tl.type === t && tr.type === t && bl.type === t && br.type === t;
    } catch (err) {
      return false;
    }
  }
  ...
  setColInactive(x) {
    ...
    for (let y = 0; y < this.getHeight(); y += 1) {
      ...
      if (block.state === __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].ACTIVE) {
        this.setBlockAt(x, y, { state: __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].INACTIVE });
        has_active = true;
      }
    }
    return has_active;
  ...
  clearBlocksUpTo(x) {
    ...
    for (let i = 0; i <= x; i += 1) {
      for (let j = this.getHeight() - 1; j >= 0; j -= 1) {
        ...
        if (block.state === __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].INACTIVE) {
          if (block.type === __WEBPACK_IMPORTED_MODULE_1__utils_constants__["b" /* BlockTypeEnum */].T1) {
          ...
          if (block.type === __WEBPACK_IMPORTED_MODULE_1__utils_constants__["b" /* BlockTypeEnum */].T2) {
          ...
          this.setBlockAt(i, j, {
            type: __WEBPACK_IMPORTED_MODULE_1__utils_constants__["b" /* BlockTypeEnum */].NONE,
            state: __WEBPACK_IMPORTED_MODULE_1__utils_constants__["a" /* BlockStateEnum */].NORMAL,
            count: 0
          });
        }
      }
      ...
      for (let j = this.getHeight() - 1; j >= 0; j -= 1) {
        let block = this.getValue(i, j);
        if (block.type === __WEBPACK_IMPORTED_MODULE_1__utils_constants__["b" /* BlockTypeEnum */].NONE) {
          let is_found = false;
          for (let k = j - 1; k >= 0; k -= 1) {
            let next_block = this.getValue(i, k);
            if (next_block.type !== __WEBPACK_IMPORTED_MODULE_1__utils_constants__["b" /* BlockTypeEnum */].NONE) {
              is_found = true;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_constants__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_utils__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Controls__ = __webpack_require__(33);
const React = __webpack_require__(0);
...
class Engine extends React.Component {
  ...
  resolveCollision() {
    ...
    if (grid.isOverlap(loc.x, loc.y, block)) {
      ...
      this.newBlockTs = Object(__WEBPACK_IMPORTED_MODULE_1__utils_utils__["a" /* now */])();
      this.startNewDropTimer();
    }
  }
  ...
  handleInstructionsUpdate(instruction) {
    if (this.newBlockTs && Object(__WEBPACK_IMPORTED_MODULE_1__utils_utils__["a" /* now */])() - this.newBlockTs < 200) {
      return;
    }
    ...
    if (instruction === __WEBPACK_IMPORTED_MODULE_0__utils_constants__["d" /* Instructions */].DOWN) {
      loc.y += 1;
    }
    if (instruction === __WEBPACK_IMPORTED_MODULE_0__utils_constants__["d" /* Instructions */].ROTATE_L) {
      block.rotateLeft();
    }
    if (instruction === __WEBPACK_IMPORTED_MODULE_0__utils_constants__["d" /* Instructions */].ROTATE_R) {
      block.rotateRight();
    }
    this.resolveCollision();
    this.props.updateGrid(this.props.grid);
  ...
  startNewDropTimer() {
    ...
    this.blockDropID = setInterval(() => this.blockDrop(), 3000);
  }

  startLineTimer() {
    this.lineID = setInterval(() => this.clearLine(), 1000 / FRAME_RATE);
  }

  render() {
    return React.createElement(__WEBPACK_IMPORTED_MODULE_2__Controls__["a" /* Controls */], { updateInstructions: this.handleInstructionsUpdate });
  }
}
...
class Controls extends React.Component {
  ...
  componentDidMount() {
    ...
    this.updateID = setInterval(() => this.sendInstruction(), 1000 / 100);
  }
  ...
  sendInstruction() {
    ...
    let time_limit = 150;
    if (this.currInstruction === __WEBPACK_IMPORTED_MODULE_0__utils_constants__["d" /* Instructions */].DOWN) {
      time_limit = 0;
    }

    if (!this.lastTime || Object(__WEBPACK_IMPORTED_MODULE_1__utils_utils__["a" /* now */])() - this.lastTime < time_limit) {
      return;
    }
  ...
  handleKeyDown(event) {
    ...
    if (instruction !== this.currInstruction) {
      this.lastTime = Object(__WEBPACK_IMPORTED_MODULE_1__utils_utils__["a" /* now */])();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__UI_BoardUI__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__UI_Score__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__UI_Timer__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__UI_Overlay__ = __webpack_require__(39);
...
class Screen extends React.Component {
  render() {
    ...
    if (this.props.gameState === __WEBPACK_IMPORTED_MODULE_4__utils_constants__["c" /* GameState */].STARTING) {
    ...
    if (this.props.gameState === __WEBPACK_IMPORTED_MODULE_4__utils_constants__["c" /* GameState */].ENDED) {
      value = React.createElement('i', { onClick: this.props.restartGame, className: 'fas fa-redo-alt' });
    }
    ...
    if (value) {
      ...
      overlay = React.createElement(__WEBPACK_IMPORTED_MODULE_3__UI_Overlay__["a" /* Overlay */], { content: item });
    }
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { style: { display: 'flex', flexBasis: '65%', justifyContent: 'flex-end' } },
          React.createElement(__WEBPACK_IMPORTED_MODULE_0__UI_BoardUI__["a" /* BoardUI */], {
        ...
        React.createElement(
          'div',
          { style: { display: 'flex', flexBasis: '35%', justifyContent: 'flex-start' } },
          React.createElement(
            'div',
            { style: timeScoreStyle },
            React.createElement(__WEBPACK_IMPORTED_MODULE_2__UI_Timer__["a" /* Timer */], { timeLimit: this.props.timeLimit }),
            React.createElement(__WEBPACK_IMPORTED_MODULE_1__UI_Score__["a" /* Score */], { score: this.props.score })
          )
        ),
        overlay
      )
...
class BoardUI extends React.Component {
  generateCellStyle(block) {
    if (block.type === __WEBPACK_IMPORTED_MODULE_0__utils_constants__["b" /* BlockTypeEnum */].NONE) {
      return cellStyle;
    }

    if (block.state === __WEBPACK_IMPORTED_MODULE_0__utils_constants__["a" /* BlockStateEnum */].INACTIVE) {
      return cellStyle;
    }

    let style = Object.assign({}, cellStyle);
    style.border = '2px solid black';
    if (block.type === __WEBPACK_IMPORTED_MODULE_0__utils_constants__["b" /* BlockTypeEnum */].T1) {
      if (block.state === __WEBPACK_IMPORTED_MODULE_0__utils_constants__["a" /* BlockStateEnum */].NORMAL) {
        style.backgroundColor = __WEBPACK_IMPORTED_MODULE_1__constants__["d" /* Orange */];
      } else if (block.state === __WEBPACK_IMPORTED_MODULE_0__utils_constants__["a" /* BlockStateEnum */].ACTIVE) {
        style.backgroundColor = __WEBPACK_IMPORTED_MODULE_1__constants__["b" /* DarkOrange */];
      }
    }

    if (block.type === __WEBPACK_IMPORTED_MODULE_0__utils_constants__["b" /* BlockTypeEnum */].T2) {
      if (block.state === __WEBPACK_IMPORTED_MODULE_0__utils_constants__["a" /* BlockStateEnum */].NORMAL) {
        style.backgroundColor = __WEBPACK_IMPORTED_MODULE_1__constants__["c" /* OffWhite */];
      } else if (block.state === __WEBPACK_IMPORTED_MODULE_0__utils_constants__["a" /* BlockStateEnum */].ACTIVE) {
        style.backgroundColor = __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* DarkOffWhite */];
      }
    }
  ...
  generateCell(key, style) {
    return React.createElement('th', { key: key, style: style });
  }
  ...
  setGridStyle(x, y, table, has_set) {
    ...
    if (block.state !== __WEBPACK_IMPORTED_MODULE_0__utils_constants__["a" /* BlockStateEnum */].ACTIVE) {
      has_set[y][x] = true;
    ...
    for (let i = -1; i <= 1; i += 1) {
      for (let j = -1; j <= 1; j += 1) {
        ...
        try {
          ...
          if (block.type === start_block.type && block.count === start_block.count) {
            pattern |= 1 << idx;
          }
        } catch (err) {
          continue;
  ...
  render() {
    ...
    for (let i = queue.length - 1; i >= 0; i -= 1) {
      ...
      block_queue.push(React.createElement(
        'th',
        { style: { border: '1px solid black', padding: '5 0 5 0' }, key: i },
        React.createElement(
          'table',
          { style: tableStyle },
          React.createElement(
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { style: containerStyle },
          React.createElement('div', { style: line_style }),
          React.createElement(
            'table',
            { style: tableStyle },
            React.createElement(
...
/* harmony export (immutable) */ __webpack_exports__["a"] = BoardUI;
...
"use strict";
const Orange = '#eb9634';
/* harmony export (immutable) */ __webpack_exports__["d"] = Orange;

const DarkOrange = '#c4732a';
/* harmony export (immutable) */ __webpack_exports__["b"] = DarkOrange;

const OffWhite = '#ebe8ed';
/* harmony export (immutable) */ __webpack_exports__["c"] = OffWhite;

const DarkOffWhite = '#c4c2c6';
/* harmony export (immutable) */ __webpack_exports__["a"] = DarkOffWhite;
